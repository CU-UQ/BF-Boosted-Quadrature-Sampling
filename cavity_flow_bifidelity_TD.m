...
for tr = 1:no_trials
    [x_sol, ~, samp_list] = total_degree_sampling(N,D,J,An,Un_sq,no_samp,y,'alev');
 ...
 % Uniform sampling
    [x_sol, ~, samp_list] = total_degree_sampling(N,D,J,An,Un_sq,no_samp,y,'unif');
...
save('C_no_18_TD.mat','err_exact','err_QR','err_lev_score','err_lev_score_boosted','err_unif','err_unif_boosted','err_lev_vol','err_lev_vol_boosted');
save('C_Cor_no_18_TD.mat','corr_lev','corr_unif','corr_lev_vol');
